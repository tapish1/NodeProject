...
class GetRequest extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch("/prod?businessId=us-east-1:a7584b1c-f10f-4747-9573-dee791a48297")
            ...
            .then(data => {this.setState({ buisness: data });})
            }
    ...
    render() {
        ...
        return (
            ...
            <hr style={{height: "6px", border:"0", margin:"0",  boxShadow: "inset 0 12px 12px -12px rgba(0, 0, 0, 0.5)"}}></hr>

            <div className="container">
            <h1>Influencers</h1><br></br>
            
            <Row >
            { this.state.buisness.map((elem, index)=>{
                    return <Col md={6}>
                    <div style={{marginBottom: "10px"}}><Card shadow={1} style={{ width: "100%", margin: "auto", borderWidth: "1px", marginBottom: "0px", paddingBottom: '0px'}}>
                        <Container>
                            <Row style={{height: "100px"}}>
                                ...
                                <Col  md={10}>
                                    <CardTitle>@{elem.instagramId} <span style={{marginLeft: '65%'}}></span>{ this.capitalize(elem.status) }</CardTitle>
                                    <Row>
                                        <Col style={{fontSize: '14px'}}> { this.dateConverter( elem.date ) } - Lorem ipsum dolor sit amet, consecteur adispling etit. Susspendie velit massa.</Col>
                                    </Row> 
                                </Col>
                            </Row> 
