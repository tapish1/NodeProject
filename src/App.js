  ...
  render() {
    ...
    return (
      ...
      <SidebarHeader>
        ...
        <hr style={{borderBottom: '0.1em solid #d8d8d8', borderTop: '0px'}}></hr>
        ...
        >
          <img width={130} height={100} src={SmashLogo} alt="Smash logo" />
        </div>
      ...
      <SidebarContent >
        <Menu iconShape="circle">
          ...
          <MenuItem className="menuI" icon={<FaSearch />}> <span>My Nodes</span> </MenuItem>
          <MenuItem className="menuI"> 
          <img className='Icon' src={usersIcon}></img>
          <span>Influencers </span></MenuItem>
          <MenuItem className="menuI"> 
          <img className='Icon' src={canvasIcon}></img>
          <span>Content </span></MenuItem>
          <MenuItem className="menuI"> 
          <img className='Icon' src={starIcon}></img>
          <span>Favourite </span></MenuItem>
          <MenuItem className="menuI"> 
          <img className='Icon' src={reviewIcon}></img>
          <span>Reviews </span></MenuItem>
          <MenuItem className="menuI"> 
          <img className='Icon' src={profileIcon}></img>
          <span>Profile </span></MenuItem>
        </Menu>
      </SidebarContent>
